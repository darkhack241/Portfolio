...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'surajfate67@gmail.com',
    href: 'mailto:surajfate67@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 93253 49403',
    href: 'https://wa.me/919325349403',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/suraj-fate',
    href: 'https://www.linkedin.com/in/suraj-fate/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@surajfate',
    href: 'https://github.com/surajfate',
  },
];
  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.15} y={20}>
        ...
        >
          Open to AI/ML Engineering, Backend, LLMOps & Agentic Systems roles
        </p>
      </FadeIn>
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          ...
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            AI Engineer · Mumbai / Nashik, India
          </span>
        </div>
      </FadeIn>
    </section>
